...
{
    public class SynchronizationRecordValidation:ISynchronizationRecordValidation, INotifyDataErrorInfo, INotifyPropertyChanged
    {
        #region Fields
        ...
        public void ValidateProp( object value, [CallerMemberName] string propertyName = "" )
        {
            switch (propertyName)
            {
                case nameof(SynchronizationEvent.StartDate):
                case nameof(SynchronizationEvent.EndDate):
